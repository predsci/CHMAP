...
# In this case, we only need all AIA images from 2025-04-01
hist_images = db_funs.query_euv_images(db_session, time_min=datetime.datetime(2025, 4, 1, 0, 0, 0),
...
lbcc_coef_start = datetime.datetime(2025, 4, 1, 0, 0, 0) - window_del/2
