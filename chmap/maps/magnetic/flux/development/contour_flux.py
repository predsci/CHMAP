...
# having trouble with the astropy timestamps, this should be extracted from frame
...
net_flux, abs_flux = br_flux.coronal_flux(db_session, test_contour, frame_timestamp,
                                          map_dir, window_half_width=window_half_width)
